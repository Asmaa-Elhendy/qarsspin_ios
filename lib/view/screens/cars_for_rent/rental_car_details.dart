    ...
    return OrientationBuilder(
      builder: (context, orientation) {
        ...
        return Scaffold(
          ...
          bottomNavigationBar:
          isLandscape ? null : RentalBottomNaviagtion(phone: widget.rentalCar.ownerMobile),
          body: Column(
            children: [
              GestureDetector(
                onTap: () {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Divider(thickness: .7.h, color: AppColors.divider(context)),
                          Text(
                            lc.rental_prices,
                            style: TextStyle(
                              color: AppColors.blackColor(context),
                          ...
                          PriceTable(car: widget.rentalCar),
                          Divider(thickness: .7.h, color: AppColors.black),
                          4.verticalSpace,
                          Padding(
                            padding: EdgeInsets.symmetric(horizontal: 55.w),
                            child: Column(
                              children: [
                                Row(
                                  children: [
                                    column(lc.chassis_number, widget.rentalCar.chassisNumber, lc),
                                    Spacer(),
                                    column(
                                        lc.year,
                                        widget.rentalCar.manufactureYear.toString(),
                                        lc)
                                  ],
                                ),
                                30.verticalSpace,
                                Row(
                                  children: [
                                    column(lc.mileage, widget.rentalCar.mileage.toString(), lc),
                                    Spacer(),
                                    column(
                                        lc.for_leasing,
                                        widget.rentalCar.availableForLease == 0
                                ...
                                Row(
                                  children: [
                                    column(lc.exterior, widget.rentalCar.mileage.toString(), lc,
                                        color: true),
                                    Spacer(),
                                    column(lc.interior, widget.rentalCar.mileage.toString(), lc,
                                        color: true),
                                  ],
                                ),
                              ],
                          ...
                          headerText(lc.specifications, context),
                          8.verticalSpace,
                          GetBuilder<RentalCarsController>(builder: (controller) {
                            return specifications(controller.spec);
                          }),
                        ],
                      ),
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Center(
              child: Text(title,
                  style: TextStyle(color: AppColors.blackColor(context), fontSize: 16.sp)),
            ),
          ),
          2.5.horizontalSpace,
          Container(
