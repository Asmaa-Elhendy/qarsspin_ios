...
class _CarDetailsState extends State<CarDetails> {
          ...
          return Scaffold(
                        ...
                        InkWell(
                          onTap: () {
                            authController.registered
                              ...
                              add: controller.carDetails.isFavorite! ? false : true,
                              postId: widget.id,
                            )
                                : showDialog(
                              context: context,
                          ...
                          child: Theme.of(context).brightness == Brightness.dark
                              ? Icon(
                            Icons.favorite,
                            color: controller.carDetails.isFavorite!
                                ? AppColors.primary
            ...
            bottomNavigationBar: isLandscape
              ...
              onMakeOffer: () async {
                await showDialog(
                  context: context,
                  builder: (_) =>
                  authController.registered ? MakeOfferDialog() : RegisterDialog(),
                );
              },
              onRequestToBuy: () async {
                await showDialog(
                  ...
                  builder: (_) => authController.registered
                    ...
                    offer: false,
                    requestToBuy: true,
                    price: controller.carDetails.askingPrice,
                  )
                      : RegisterDialog(),
                );
              },
            ...
            body: controller.oldData
              ...
              child: Container(
                color: AppColors.black.withOpacity(0.5),
                child: Center(
                  child: AppLoadingWidget(title: lc.loading),
                ),
              ),
            )
                : Column(
              children: [
                GestureDetector(
                  ...
                  child: SizedBox(
                    ...
                    child: CarImage(allImages: controller.postMedia),
                  ),
                ),
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              blueText("${controller.carDetails.visitsCount} ${lc.people_view}"),
              4.verticalSpace,
              headerText(
              ...
              12.verticalSpace,
              Divider(thickness: .5, color: AppColors.divider(context)),
              Center(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    greyText(lc.price),
                    2.verticalSpace,
                    price("${controller.carDetails.askingPrice} ${lc.currency_Symbol}"),
                    2.verticalSpace,
                    boldGrey("${controller.carDetails.offersCount} ${lc.people_made_offer}")
                  ],
                ),
              ),
              Divider(thickness: .5, color: AppColors.divider(context)),
            ...
            children: [
              ...
              Column(
                children: [
                  boldGrey(lc.year),
                  4.verticalSpace,
                  headerText("${controller.carDetails.manufactureYear}", context),
                ],
              ),
            ],
          ),
            ...
            children: [
              Column(
                children: [
                  boldGrey(lc.mileage),
                  4.verticalSpace,
                  headerText(controller.carDetails.mileage.toString(), context),
                ],
              ),
              Column(
                children: [
                  boldGrey(lc.warranty),
                  4.verticalSpace,
                  headerText(controller.carDetails.warrantyAvailable, context),
                ],
              ),
            ],
          ),
  ...
  Widget specifications(List<Specifications> spec) {
    return Column(
      children: [for (var s in spec) specificationsRow(s.key, s.value)],
    );
  }
