...
class CarImage extends StatefulWidget {
  ...
  const CarImage({required this.allImages, super.key});
...
class _CarImageState extends State<CarImage> {
  ...
  void initState() {
    ...
    if (widget.allImages.isNotEmpty && widget.allImages[0] != "") {
      _controller = WebViewController()
        ..setJavaScriptMode(JavaScriptMode.unrestricted)
        ..loadRequest(Uri.parse(widget.allImages[0]));
    }
  ...
  Widget build(BuildContext context) {
    return OrientationBuilder(
      builder: (context, orientation) {
        ...
        // full screen للـ 360 عند Landscape
        final height = isLandscape ? MediaQuery.of(context).size.height : 250.h;

        return SizedBox(
          width: double.infinity,
          height: height,
          child: widget.allImages.isNotEmpty && widget.allImages[0] != ""
